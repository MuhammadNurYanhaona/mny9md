...
class Expr : public Stmt 
{
  ...
  public:
    ...
    void Emit(CodeGenerator *codegen) { this->generateCode(codegen); }	 
    virtual Location* generateCode(CodeGenerator *codegen) { return NULL; }			
};
...
class IntConstant : public Expr 
{
  ...
  public:
    ...
    Location* generateCode(CodeGenerator *codegen) { return codegen->GenLoadConstant(value); }	 	
};
...
class NullConstant: public Expr 
{
  public: 
    ...
    Location* generateCode(CodeGenerator *codegen) { return codegen->GenLoadConstant(0); }	 	
};
